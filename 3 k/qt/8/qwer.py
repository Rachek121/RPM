...
from PyQt6.QtWidgets import QApplication, QMainWindow, QTableWidget, QTableWidgetItem, QVBoxLayout, QWidget, QComboBox, QFileDialog
...
class OlympiadResults(QMainWindow):
    ...
    def initUI(self):
        self.setWindowTitle("ОЛИМПИЙСКИЕ РЕЗУЛЬТАТЫ")
    ...
    def filter_results(self):
        ...
        filtered_data = [row for row in self.data if row["login"].split("-")[1] == school and row["login"].split("-")[2] == class_]
